...
const UserSchema = CollectionSchema(
  ...
  links: {
    r'gameResults': LinkSchema(
      id: 7193676481177941972,
      name: r'gameResults',
      target: r'GameResult',
      single: false,
    ),
    r'settings': LinkSchema(
      id: -1306297338583733126,
      name: r'settings',
      target: r'Settings',
      single: true,
    ),
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> gameResults(
      FilterQuery<GameResult> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'gameResults');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> gameResultsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'gameResults', length, true, length, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> gameResultsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'gameResults', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> gameResultsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'gameResults', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> gameResultsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'gameResults', 0, true, length, include);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> gameResultsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'gameResults', length, include, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> gameResultsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'gameResults', lower, includeLower, upper, includeUpper);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> settings(
